...
class ExtraInfoPopup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      insetPadding: EdgeInsets.symmetric(vertical: MediaQuery.of(context).size.height * 0.30, horizontal: 20),
      content: Column (
        ...
        children: [
          ...
          Text("Type: ${lot.lotInfo.lotDescription}", style: TextStyle(color: Colors.white), textAlign: TextAlign.left),
